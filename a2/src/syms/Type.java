...
public abstract class Type {
     ...
     * The value ErrorHandler.NO_LOCATION is used to indicate
     * that the error has no location in the code.
     */
    ...
    /**
     * VOID_TYPE
     * Void type is used for the return type of procedures (i.e. no return type).
     */
    ...
    public static class ProcedureType extends Type {
        /**
         * The result type for a function or Type.VOID_TYPE otherwise.
         */
        Type resultType;
        ...
        public String toString() {
            ...
            s.append(")");
            s.append(resultType == null ? "" : " : " + resultType);
            return s.toString();
        }
    }
    ...
    public RecordType getRecordType() {
        ...
        if (thisType instanceof RecordType recordType) {
            return recordType;
        }
        return null;
    }
    ...
    public static class RecordType extends Type {
        ...
        /* Map of field names to their corresponding fields for efficient lookup. */
        protected SortedMap<String, Field> fieldMap;
        /*The total space required to store the fields of the record.
          Not resolved until the record type is resolved. */
        protected int fieldSpace;

        public RecordType(Location loc,
                          List<Field> fields) {
            /* The value of a record is the absolute (i.e. global) address where
            the value of the fields of the record are stored. */
            super(loc, SIZE_OF_ADDRESS);
            this.fields = fields;
            initialiseFieldMap();
        }
         ...
         */
        private void initialiseFieldMap() {
        ...
        /**
         * Returns the total space required to store the fields of the record.
         *
         * @requires resolved
         * @return the total space required to store the fields of the record.
         */
        ...
        public Type resolveType() {
            ...
            if(!resolved) {
                /* As a record type may validly circularly reference itself
                 * we set the record type to resolved before resolving its fields and
                 * allocating space for them.
                 */
                resolved = true;
                fieldSpace = allocFields();
            }
            return this;
        }
        ...
        /**
         * Coerce expression to 'this' RecordType
         * The objective is to create an expression of 'this' record type
         * from exp.
         *
         * @param exp expression to be coerced
         * @return the coerced expression
         * @throws IncompatibleTypes exception if it is not possible to coerce
         *                           exp to 'this' record Type
         */
        @Override
        public ExpNode coerce(ExpNode exp) throws IncompatibleTypes {
            Type fromType = exp.getType();
            /* nil is a valid element of any record type */
            if (fromType.equals(Predefined.NIL_TYPE)) {
                errors.debugMessage("Coerced " + fromType + " to " + this);
                return exp;
            }
            throw new IncompatibleTypes("cannot treat " + exp.getType() + " as " + this,
                    exp.getLocation());
        }
    ...
    public static class Field {
        ...
        @Override
        public String toString() {
            // use typeIdName instead of type to avoid cyclic toString invocations.
            return id + ":" + typeIdName;
        }
    }
